...
const card = document.getElementsByClassName("card");
    //card.allEmployees = card(allEmployees);
...
function methodCaller(allEmployees){
  ...
  function uniqueId(allEmployees){
    Math.floor(Math.random() * 10000);
    this.employeeId=uniqueId(this.employeeId);
  }
  function modifyText(new_text) {
    const fullname = document.getElementById("fullname");
    fullname.firstChild.nodeValue = new_text;
    const department = document.getElementById("department");
    department.secondChild.nodeValue = new_text;
    const level = document.getElementById("level");
    level.secondChild.nodeValue = new_text;
    const imageurl = document.getElementById("imageurl");
    imageurl.thirdChild.nodeValue = new_text;
  }
